...
\newcommand{\CS}[1]{\textcolor{Cerulean}{CS: #1}}
\newcommand{\HM}[1]{\textcolor{ProcessBlue}{HM: #1}}
\newcommand{\TODO}[1]{\textcolor{Melon}{TODO: #1}}
\newcommand{\BL}[1]{\textcolor{Melon}{BL: #1}}
\newcommand{\XXX}[1]{\textcolor{Red}{XXX: #1}}
\newcommand{\IS}[1]{\textcolor{Aquamarine}{IS: #1}}
...
\newcommand{\evalp}[1]{(\pgfmathparse{#1}\pgfmathprintnumberto[precision=2]{\pgfmathresult}{\temp}\temp\%)}
