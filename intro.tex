...
Toward this end, we demonstrate the signficant, negative consequences of holes with respect to hardware cost and response time and shows how holes can be minimized.
