...
We propose a hardware realization of a pipelined binary heap that addresses holes. 
Our primary contribution, a hole minimization technique, forces the tree structure to be a complete binary heap.
